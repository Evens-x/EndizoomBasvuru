...
namespace EndizoomBasvuru.Migrations
{
    ...
    [Migration("20250421190755_mig_7")]
    partial class mig_7
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EndizoomBasvuru.Entity.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "$2a$11$lRfU4OwfuKWNpEY0BGOGwOdhqI6wQIpZlJXz.2criJauV1MJ9gEJ6",
                            Role = 1,
                            Username = "superadmin"
                        },
                        new
                        {
                            ...
                            IsActive = true,
                            LastName = "Marketing",
                            Password = "$2a$11$OaxRTrgpEF5IevYIxoA3O.k7iNqJ8TKeiMprBH8Od01NNAWOV4W3y",
                            Role = 2,
                            Username = "marketing"
                        });
                });
            ...
            modelBuilder.Entity("EndizoomBasvuru.Entity.Company", b =>
                {
                    ...
                    b.HasOne("EndizoomBasvuru.Entity.Admin", "UpdatedBy")
                        .WithMany()
