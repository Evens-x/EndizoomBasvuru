...
namespace EndizoomBasvuru.Migrations
{
    ...
    [Migration("20250424102131_mig_8")]
    partial class mig_8
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EndizoomBasvuru.Entity.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "$2a$11$1P2VXYzqZEZmGIgUWRieCerQ4ej.QLq.78Lx3msOcCNe64WS2DlQ.",
                            Role = 1,
                            Username = "superadmin"
                        },
                        new
                        {
                            ...
                            IsActive = true,
                            LastName = "Marketing",
                            Password = "$2a$11$kXypbWj/O1SvbKhgGFBx2uk.YFMF4FvoLYMWJTHcAp2mIylLDP/cq",
                            Role = 2,
                            Username = "marketing"
                        });
                });
